...
export default function BuyerActivityPage() {
  ...
  const load = useCallback((pageNum?: number) => {
    ...
    api.getProcurementActivity(params)
      .then((res) => {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
      <div className="flex items-center justify-between gap-4">
        <h1 className="font-display text-3xl font-semibold tracking-tight text-ink">Activity</h1>
      ...
      {loading ? (
        ...
        <div className="mt-12 flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-sm text-soft">No activity yet</p>
          <Link href="/procurement/requests/new" className="btn btn-primary">Create Procurement Request</Link>
        </div>
      ) : (
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-1 flex flex-wrap gap-x-4 gap-y-1 text-xs text-muted">
                    ...
                    {a.procurement_request_id && (
                      <Link href={`/procurement/requests/${a.procurement_request_id}`} className="text-accent hover:underline">
                        View Request
                      </Link>
                    )}
